...
$url_ok = "https://ocular.ch/"; //Zielseite, wenn E-Mail erfolgreich versendet wurde
...
if($mail_senden){
	...
	header("Location: ".$url_ok); 
  	...
  	echo("Beim Senden der Mail ist ein Fehler aufgetreten. Versuche es bitte später no einmal."); //Fehler beim Senden
}